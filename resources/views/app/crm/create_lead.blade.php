    ...
    <div class="max-w-7xl mx-auto space-y-6" x-data="{
        ...
        <div class="rounded-2xl bg-slate-900 border border-slate-800 shadow-xl overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-800/80 bg-slate-950/40">
                <h2 class="text-sm font-bold text-white tracking-wide">Add New Lead</h2>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        <div>
                            ...
                            <input type="text" name="name" required value="{{ old('name') }}" placeholder="" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs placeholder-slate-500 focus:border-indigo-500 focus:outline-none transition-all">
                        </div>

                        <div>
                            <label class="block text-xs font-semibold text-slate-300 mb-1.5">Phone</label>
                            <input type="text" name="phone" value="{{ old('phone') }}" placeholder="" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs placeholder-slate-500 focus:border-indigo-500 focus:outline-none transition-all">
                        </div>

                        <div>
                            <label class="block text-xs font-semibold text-slate-300 mb-1.5">Email</label>
                            <input type="email" name="email" value="{{ old('email') }}" placeholder="" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs placeholder-slate-500 focus:border-indigo-500 focus:outline-none transition-all">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        <div>
                            ...
                            <input type="text" name="instagram_handle" value="{{ old('instagram_handle') }}" placeholder="@username" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs placeholder-slate-500 focus:border-indigo-500 focus:outline-none transition-all">
                        </div>

                        <div>
                            <label class="block text-xs font-semibold text-slate-300 mb-1.5">City</label>
                            <input type="text" name="city" value="{{ old('city') }}" placeholder="" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs placeholder-slate-500 focus:border-indigo-500 focus:outline-none transition-all">
                        </div>

                        <div>
                            <label class="block text-xs font-semibold text-slate-300 mb-1.5">Member Count</label>
                            <input type="number" min="1" name="member_count" value="{{ old('member_count', 1) }}" placeholder="1" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs placeholder-slate-500 focus:border-indigo-500 focus:outline-none transition-all">
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-4 pt-4 border-t border-slate-800/80">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        <div>
                            ...
                            <input type="text" name="next_action" value="{{ old('next_action') }}" placeholder="e.g. Follow up call" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs placeholder-slate-500 focus:border-indigo-500 focus:outline-none transition-all">
                        </div>

                        <div>
                            <label class="block text-xs font-semibold text-slate-300 mb-1.5">Next Action Date</label>
                            <input type="date" name="follow_up_date" value="{{ old('follow_up_date') }}" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs placeholder-slate-500 focus:border-indigo-500 focus:outline-none transition-all">
                        </div>
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="4" placeholder="" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs placeholder-slate-500 focus:border-indigo-500 focus:outline-none transition-all resize-y">{{ old('notes') }}</textarea>
                    </div>
                </div>
