    ...
    <div x-data="{
        ...
        @if ($errors->any())
            <div class="p-3.5 sm:p-4 rounded-2xl bg-rose-50 dark:bg-rose-500/10 border border-rose-200 dark:border-rose-500/20 text-rose-700 dark:text-rose-300 text-xs space-y-1 shadow-sm">
                ...
                <ul class="list-disc list-inside text-rose-600 dark:text-rose-400/90 pl-1 space-y-0.5">
        ...
        <!-- ========================================================================= -->
        <!-- MODE 1: REGISTER NEW MEMBER FORM -->
        <!-- ========================================================================= -->
        <form x-show="mode === 'new'" 
            ...
            <div class="p-4 sm:p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4 sm:space-y-6">
                <div class="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800/80 pb-4">
                    ...
                    <div>
                        <h2 class="text-base font-black text-slate-900 dark:text-white">Personal Information</h2>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Basic contact and identification details</p>
                    </div>
                </div>

                <!-- Avatar & Photo Actions (Upload / Webcam Capture) -->
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6 p-4 rounded-xl bg-slate-50 dark:bg-slate-950/40 border border-slate-200 dark:border-slate-800/60">
                    <div class="relative group">
                        <div class="w-24 h-24 rounded-full bg-slate-100 dark:bg-slate-800 border-2 border-slate-300 dark:border-slate-700 overflow-hidden flex items-center justify-center shadow-md">
                            <template x-if="photoPreview">
                                <img :src="photoPreview" alt="Profile preview" class="w-full h-full object-cover">
                            </template>
                            <template x-if="!photoPreview">
                                <svg class="w-12 h-12 text-slate-400 dark:text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                            </template>
                        </div>
                    </div>

                    <div class="flex flex-col justify-center space-y-2 text-center sm:text-left">
                        <span class="text-xs font-bold text-slate-800 dark:text-slate-300">Member Photo</span>
                        <div class="flex flex-wrap items-center justify-center sm:justify-start gap-2.5">
                            ...
                            <button type="button" 
                                    @click="openWebcam()"
                                    class="px-3.5 py-2 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 dark:bg-indigo-600/20 dark:hover:bg-indigo-600/30 dark:text-indigo-400 dark:border-indigo-500/30 text-xs font-bold flex items-center gap-2 transition-all cursor-pointer shadow-sm">
                        ...
                        <p class="text-[11px] text-slate-500 dark:text-slate-400">JPG, PNG or GIF. Max 5MB.</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 text-xs focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none shadow-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative flex items-center">
                            ...
                            <input type="tel" 
                                   ...
                                   class="w-full pl-12 pr-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 text-xs focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none shadow-sm">
                        </div>
                    </div>

                    <!-- Alternate Phone -->
                    <div>
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Alternate Phone</label>
                        <input type="tel" 
                    ...
                    <div>
                        ...
                        <select name="gender" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none shadow-sm">
                    ...
                    <div>
                        ...
                        <input type="date" 
                               name="dob" 
                               value="{{ old('dob') }}" 
                               class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none shadow-sm">
                    </div>

                    <!-- Blood Group -->
                    <div>
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Blood Group</label>
                        <select name="blood_group" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none shadow-sm">
                ...
                <div class="pt-4 border-t border-slate-200 dark:border-slate-800/80">
                    <div class="flex items-center gap-2.5 mb-2">
                        <div class="w-6 h-6 rounded-md bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center font-bold text-xs">
                            💬
                        </div>
                        <span class="text-xs font-black text-slate-900 dark:text-white">WhatsApp Notifications</span>
                    </div>
                    <label class="flex items-start gap-3 p-3.5 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 cursor-pointer transition-colors shadow-sm">
                        <input type="checkbox" 
                               name="whatsapp_disabled" 
                               value="1" 
                               {{ old('whatsapp_disabled') ? 'checked' : '' }} 
                               class="mt-0.5 rounded bg-white dark:bg-slate-900 border-slate-300 dark:border-slate-700 text-indigo-600 focus:ring-indigo-500 w-4 h-4">
                        <div>
                            <span class="text-xs font-bold text-slate-800 dark:text-slate-200">Notifications Disabled</span>
                            <p class="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">No WhatsApp reminders will be sent (OTP not affected)</p>
                        </div>
                    </label>
                </div>
            </div>
            ...
            <div class="p-4 sm:p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4 sm:space-y-6">
                <div class="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800/80 pb-4">
                    ...
                    <div>
                        <h2 class="text-base font-black text-slate-900 dark:text-white">Membership Details</h2>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Gym branch, plan selection, trainer and access settings</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <!-- Branch -->
                    <div>
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Branch <span class="text-rose-500">*</span></label>
                        <select name="branch_id" required class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-amber-500 focus:ring-1 focus:ring-amber-500 focus:outline-none shadow-sm">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1.5">
                            <label class="block text-xs font-bold text-slate-700 dark:text-slate-300">Membership Plan</label>
                            <template x-if="selectedPlan">
                                <span class="px-2 py-0.5 rounded text-[10px] font-extrabold uppercase"
                                      :class="isDuo ? 'bg-indigo-50 dark:bg-indigo-500/20 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-500/30' : (isFamily ? 'bg-purple-50 dark:bg-purple-500/20 text-purple-700 dark:text-purple-300 border border-purple-200 dark:border-purple-500/30' : 'bg-emerald-50 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-500/30')"
                        ...
                        <select name="membership_plan_id" 
                                ...
                                @change="onPlanChange()" 
                                class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-amber-500 focus:ring-1 focus:ring-amber-500 focus:outline-none shadow-sm">
                    ...
                    <!-- Join Date -->
                    <div>
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Join Date <span class="text-rose-500">*</span></label>
                        <input type="date" 
                               name="join_date" 
                    ...
                    <!-- Lead Source -->
                    <div>
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Lead Source</label>
                        <select name="lead_source" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-amber-500 focus:ring-1 focus:ring-amber-500 focus:outline-none shadow-sm">
                    ...
                    <!-- Assigned Trainer -->
                    <div>
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Assigned Trainer</label>
                        <select name="trainer_id" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-amber-500 focus:ring-1 focus:ring-amber-500 focus:outline-none shadow-sm">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Sales Representative</label>
                        <select name="sales_rep_id" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-amber-500 focus:ring-1 focus:ring-amber-500 focus:outline-none shadow-sm">
                    ...
                    <!-- Locker Number -->
                    <div>
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Locker Number</label>
                        <input type="text" 
                               name="locker_number" 
                               value="{{ old('locker_number') }}" 
                               placeholder="e.g. L-104" 
                               class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 text-xs focus:border-amber-500 focus:ring-1 focus:ring-amber-500 focus:outline-none shadow-sm">
                    </div>

                    <!-- Max Entries Per Day -->
                    <div class="sm:col-span-2">
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Max Entries Per Day</label>
                        <input type="number" 
                ...
                <div x-show="selectedPlanId" x-transition class="p-4 rounded-xl bg-slate-50 dark:bg-slate-950/80 border border-amber-300 dark:border-amber-500/30 space-y-4 shadow-sm">
                    <div class="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-3">
                        <span class="text-xs font-bold text-slate-800 dark:text-slate-300">Plan Fee Details</span>
                        <div class="text-xs text-amber-600 dark:text-amber-400 font-extrabold">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   step="any" 
                                   placeholder="0" 
                                   class="w-full px-3 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-amber-500 focus:outline-none">
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Net Payable Fee ({{ $currency }})</label>
                            <div class="px-3 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 text-emerald-600 dark:text-emerald-400 font-black text-xs shadow-sm">
                                {{ $currency }}<span x-text="finalFee.toFixed(2)"></span>
                            </div>
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Paid Now Amount ({{ $currency }})</label>
                            <input type="number" 
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 pt-1">
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   class="w-full px-3 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 text-xs focus:border-amber-500 focus:outline-none">
                        </div>

                        <div class="flex items-center justify-between p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
                            <div>
                                <span class="text-[11px] text-slate-500 dark:text-slate-400 font-bold">Remaining Due Balance</span>
                                <p class="text-sm font-black mt-0.5" :class="remainingBalance > 0 ? 'text-amber-600 dark:text-amber-400' : 'text-emerald-600 dark:text-emerald-400'">
                                    {{ $currency }}<span x-text="remainingBalance.toFixed(2)"></span>
                                </p>
                            </div>
                            <span class="px-2 py-1 rounded-md text-[10px] font-extrabold uppercase tracking-wider shadow-sm" 
                                  :class="remainingBalance > 0 ? 'bg-amber-50 dark:bg-amber-500/10 text-amber-700 dark:text-amber-400 border border-amber-200 dark:border-amber-500/30' : 'bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/30'"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="flex items-center gap-2">
                                <h2 class="text-base font-black text-slate-900 dark:text-white">Duo Partner Details (Member #2)</h2>
                                <span class="px-2 py-0.5 rounded text-[10px] font-extrabold bg-indigo-50 dark:bg-indigo-500/20 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-500/30">2 Persons Total</span>
                            </div>
                            <p class="text-xs text-slate-500 dark:text-slate-400">Primary member is Member #1. Enter the details for the 2nd person included in this Duo plan.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 text-xs focus:border-indigo-500 focus:outline-none shadow-sm">
                    </div>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Gender</label>
                        <select name="group_members[0][gender]" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-indigo-500 focus:outline-none shadow-sm">
                    ...
                    <div>
                        ...
                        <input type="date" 
                               ...
                               class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-indigo-500 focus:outline-none shadow-sm">
                    </div>

                    <div class="sm:col-span-2 lg:col-span-3">
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Relationship with Primary Member</label>
                        <input type="text" 
            ...
            <div x-show="isFamily" x-transition class="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-purple-50/70 via-white to-white dark:from-purple-950/40 dark:via-slate-900 dark:to-slate-900 border border-purple-200 dark:border-purple-500/40 shadow-sm space-y-4 sm:space-y-6">
                <div class="flex items-center justify-between border-b border-purple-200 dark:border-purple-500/20 pb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="flex items-center gap-2">
                                <h2 class="text-base font-black text-slate-900 dark:text-white">Family Members Details (Total 4 People)</h2>
                                <span class="px-2 py-0.5 rounded text-[10px] font-extrabold bg-purple-50 dark:bg-purple-500/20 text-purple-700 dark:text-purple-300 border border-purple-200 dark:border-purple-500/30">1 Primary + 3 Additional</span>
                            </div>
                            <p class="text-xs text-slate-500 dark:text-slate-400">Primary member is Member #1. Enter details for the remaining 3 members below.</p>
                        </div>
                    </div>
                </div>
                    ...
                    @foreach([
                        ...
                        <div class="p-3.5 sm:p-4 rounded-xl bg-slate-50/90 dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800 space-y-3">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                                <div>
                                    <label class="block text-[11px] font-bold text-slate-700 dark:text-slate-300 mb-1">First Name <span class="text-rose-500">*</span></label>
                                    <input type="text" 
                                           name="group_members[{{ $slot['idx'] }}][first_name]" 
                                           :required="isFamily"
                                           placeholder="First name" 
                                           class="w-full px-3 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 text-xs focus:border-purple-500 focus:outline-none">
                                </div>
                                <div>
                                    <label class="block text-[11px] font-bold text-slate-700 dark:text-slate-300 mb-1">Last Name</label>
                                    <input type="text" 
                                ...
                                <div>
                                    <label class="block text-[11px] font-bold text-slate-700 dark:text-slate-300 mb-1">Gender</label>
                                    <select name="group_members[{{ $slot['idx'] }}][gender]" class="w-full px-3 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-purple-500 focus:outline-none">
                                        <option value="male">Male</option>
                                        <option value="female">Female</option>
                                        <option value="other">Other</option>
                                    </select>
                                ...
                                <div>
                                    <label class="block text-[11px] font-bold text-slate-700 dark:text-slate-300 mb-1">Relationship</label>
                                    <input type="text" 
                                           name="group_members[{{ $slot['idx'] }}][relation]" 
                                           value="{{ $slot['default_rel'] }}"
                                           placeholder="e.g. {{ $slot['default_rel'] }}" 
                                           class="w-full px-3 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-purple-500 focus:outline-none">
                                </div>
                                <div>
                                    <label class="block text-[11px] font-bold text-slate-700 dark:text-slate-300 mb-1">Date of Birth</label>
                                    <input type="date" 
            ...
            <div class="p-4 sm:p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4 sm:space-y-6">
                <div class="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800/80 pb-4">
                    ...
                    <div>
                        <h2 class="text-base font-black text-slate-900 dark:text-white">Fitness Information</h2>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Body metrics, target goals, and medical history</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <!-- Current Weight -->
                    <div>
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Current Weight (kg)</label>
                        <input type="number" 
                               name="weight" 
                               value="{{ old('weight') }}" 
                               step="0.1" 
                               placeholder="e.g. 75.5" 
                               class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 text-xs focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none shadow-sm">
                    </div>

                    <!-- Target Weight -->
                    <div>
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Target Weight (kg)</label>
                        <input type="number" 
                               name="target_weight" 
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1.5">
                            <label class="text-xs font-bold text-slate-700 dark:text-slate-300">Height</label>
                            <div class="flex items-center gap-1 bg-slate-100 dark:bg-slate-950 p-0.5 rounded-lg border border-slate-300 dark:border-slate-800 text-[10px]">
                                <button type="button" 
                                        @click="heightUnit = 'cm'"
                                        class="px-1.5 py-0.5 rounded font-bold transition-all"
                                        :class="heightUnit === 'cm' ? 'bg-emerald-500 text-slate-950' : 'text-slate-500 dark:text-slate-400'">cm</button>
                                <button type="button" 
                                        @click="heightUnit = 'ft'"
                                        class="px-1.5 py-0.5 rounded font-bold transition-all"
                                        :class="heightUnit === 'ft' ? 'bg-emerald-500 text-slate-950' : 'text-slate-500 dark:text-slate-400'">ft.in</button>
                            </div>
                        </div>
                    ...
                    <!-- Fitness Goal -->
                    <div>
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Fitness Goal</label>
                        <select name="fitness_goal" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none shadow-sm">
                    ...
                    <div class="sm:col-span-2 lg:col-span-4">
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Health Conditions / Medical History</label>
                        <textarea name="medical_history" 
                                  ...
                                  class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 text-xs focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none shadow-sm">{{ old('medical_history') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 sm:p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4 sm:space-y-6">
                <div class="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800/80 pb-4">
                    ...
                    <div>
                        <h2 class="text-base font-black text-slate-900 dark:text-white">Emergency Contact</h2>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Whom to notify in case of an emergency</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <!-- Contact Name -->
                    <div>
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Contact Name</label>
                        <input type="text" 
                               name="emergency_contact_name" 
                               value="{{ old('emergency_contact_name') }}" 
                               placeholder="e.g. Jane Doe" 
                               class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 text-xs focus:border-rose-500 focus:ring-1 focus:ring-rose-500 focus:outline-none shadow-sm">
                    </div>
                    ...
                    <!-- Relation -->
                    <div>
                        <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Relation</label>
                        <select name="emergency_relation" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-rose-500 focus:ring-1 focus:ring-rose-500 focus:outline-none shadow-sm">
            ...
            <div class="p-4 sm:p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4 sm:space-y-6">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200 dark:border-slate-800/80 pb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-base font-black text-slate-900 dark:text-white">Identification Documents</h2>
                            <p class="text-xs text-slate-500 dark:text-slate-400">KYC verification, government IDs and document attachments</p>
                        </div>
                    </div>
                        ...
                        <div class="p-3.5 sm:p-4 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 flex flex-col lg:flex-row items-stretch lg:items-center gap-3">
                            ...
                            <div class="w-full lg:w-48">
                                ...
                                <select :name="`id_documents[${index}][type]`" 
                                        x-model="doc.type" 
                                        class="w-full px-3 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-cyan-500 focus:outline-none shadow-sm">
                            ...
                            <!-- ID Number -->
                            <div class="flex-grow">
                                <label class="block text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">ID Number</label>
                                <input type="text" 
                                       :name="`id_documents[${index}][number]`" 
                                       x-model="doc.number" 
                                       placeholder="e.g. 1234 5678 9012" 
                                       class="w-full px-3 py-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 text-xs focus:border-cyan-500 focus:outline-none shadow-sm">
                            </div>

                            <!-- Front File Upload -->
                            <div class="w-full lg:w-40">
                                <label class="block text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Front Document</label>
                                <label class="px-3 py-2 rounded-xl bg-white hover:bg-slate-100 border border-slate-300 text-slate-700 dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-slate-800 dark:text-slate-300 text-xs font-semibold flex items-center justify-between gap-1.5 cursor-pointer transition-colors overflow-hidden shadow-sm">
                                    <span class="truncate" x-text="doc.frontFileName || 'Upload Front'"></span>
                                    <svg class="w-3.5 h-3.5 text-slate-400 dark:text-slate-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"/></svg>
                                    <input type="file" 
                            ...
                            <!-- Back File Upload -->
                            <div class="w-full lg:w-40">
                                <label class="block text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Back Document</label>
                                <label class="px-3 py-2 rounded-xl bg-white hover:bg-slate-100 border border-slate-300 text-slate-700 dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-slate-800 dark:text-slate-300 text-xs font-semibold flex items-center justify-between gap-1.5 cursor-pointer transition-colors overflow-hidden shadow-sm">
                            ...
                            <div class="flex items-end justify-end pt-1">
                                <button type="button" 
                                        ...
                                        class="p-2 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200 dark:bg-rose-500/10 dark:hover:bg-rose-500/20 dark:text-rose-400 dark:border-rose-500/20 transition-all cursor-pointer shadow-sm">
            ...
            <div class="p-4 sm:p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
                <div class="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800/80 pb-4">
                    ...
                    <div>
                        <h2 class="text-base font-black text-slate-900 dark:text-white">Additional Notes</h2>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Internal remarks visible only to gym administrators</p>
                    </div>
                </div>
                ...
                <textarea name="notes" 
                          ...
                          class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 text-xs focus:border-amber-500 focus:ring-1 focus:ring-amber-500 focus:outline-none shadow-sm">{{ old('notes') }}</textarea>
            </div>
        ...
        <div x-show="mode === 'existing'" class="space-y-4 sm:space-y-6">
            ...
            <div class="p-4 sm:p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
                <div class="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800/80 pb-4">
                    ...
                    <div>
                        <h2 class="text-base font-black text-slate-900 dark:text-white">Search Member by Phone</h2>
                        <p class="text-xs text-slate-500 dark:text-slate-400">Enter the member's registered phone number to find their existing account</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row items-center gap-3">
                    <div class="relative flex items-center flex-grow w-full">
                        ...
                        <input type="tel" 
                               ...
                               class="w-full pl-12 pr-4 py-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 text-xs focus:border-amber-500 focus:outline-none shadow-sm">
                    </div>
            ...
            <template x-if="lookupCompleted && existingMember">
                <form action="{{ route('app.members.store') }}" method="POST" class="space-y-4 sm:space-y-6">
                    ...
                    <div class="p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-emerald-50/60 to-white dark:from-slate-900 dark:to-slate-950 border border-emerald-200 dark:border-emerald-500/40 shadow-sm space-y-4">
                        ...
                        <div x-show="existingMember.active_plan" class="p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs text-slate-700 dark:text-slate-300 flex items-center justify-between shadow-sm">
                            <span>Current Plan: <strong class="text-slate-900 dark:text-white" x-text="existingMember.active_plan"></strong></span>
                            <span class="text-slate-500 dark:text-slate-400">Valid Till: <strong class="text-amber-600 dark:text-amber-400" x-text="existingMember.active_plan_end"></strong></span>
                        </div>
                    </div>
                    ...
                    <div class="p-4 sm:p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            <!-- Target Branch -->
                            <div>
                                <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Gym Branch <span class="text-rose-500">*</span></label>
                                <select name="branch_id" required class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-amber-500 focus:outline-none shadow-sm">
                                    @foreach($branches as $b)
                            ...
                            <!-- Membership Plan -->
                            <div>
                                <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">New Membership Plan</label>
                                <select name="membership_plan_id" 
                                        x-model="existingSelectedPlanId" 
                                        @change="onExistingPlanChange()" 
                                        class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-amber-500 focus:outline-none shadow-sm">
                            ...
                            <!-- Start Date -->
                            <div>
                                <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">Membership Start Date</label>
                                <input type="date" 
                                       name="start_date" 
                        ...
                        <div x-show="existingSelectedPlanId" class="pt-3 grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 border-t border-slate-200 dark:border-slate-800">
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       min="0" 
                                       placeholder="0" 
                                       class="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-amber-500 focus:outline-none shadow-sm">
                            </div>
                            ...
                            <div>
                                <label class="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">Payment Method</label>
                                <select name="payment_method" x-model="existingPaymentMethod" class="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-white text-xs focus:border-amber-500 focus:outline-none shadow-sm">
                                    <option value="cash">Cash</option>
                                    <option value="upi">UPI / QR Code</option>
                                    <option value="card">Card (POS)</option>
                                    <option value="netbanking">Net Banking</option>
            ...
            <template x-if="lookupCompleted && !existingMember">
                <div class="p-6 sm:p-8 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-center space-y-4 shadow-sm">
                    ...
                    <div class="max-w-md mx-auto">
                        <h3 class="text-sm font-black text-slate-900 dark:text-white">No Member Found</h3>
                        <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">No existing member was found matching phone number <strong class="text-amber-600 dark:text-amber-400" x-text="searchPhone"></strong>.</p>
                    </div>
                    <button type="button" 
                            @click="mode = 'new'" 
            ...
            <div @click.away="closeWebcam()" class="w-full max-w-lg rounded-2xl sm:rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 overflow-hidden shadow-2xl space-y-4 p-4 sm:p-5 text-slate-900 dark:text-white max-h-[90vh] overflow-y-auto">
                <div class="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-3">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="text-sm font-black text-slate-900 dark:text-white">Capture Member Photo</h3>
                    </div>
                    <button type="button" @click="closeWebcam()" class="text-slate-400 hover:text-slate-600 dark:hover:text-white text-base">✕</button>
                </div>

                <!-- Video Preview Box -->
                <div class="relative aspect-video rounded-xl bg-black border border-slate-200 dark:border-slate-800 overflow-hidden flex items-center justify-center shadow-inner">
                ...
                <div class="flex items-center justify-between pt-2">
                    <button type="button" 
                            @click="closeWebcam()" 
                            class="px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-300 dark:border-slate-700 text-xs font-bold transition-all">
                        Cancel
                    </button>
                    <button type="button" 
                            @click="takeSnapshot()" 
                            class="px-5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-black shadow-lg shadow-indigo-600/30 flex items-center gap-2 transition-all cursor-pointer">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
