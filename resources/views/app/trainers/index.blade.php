<x-app-layout header="Fitness Trainers & Coaches">
    ...
    <div class="space-y-6" x-data="{
        ...
        <!-- ==================== MODAL 1: ADD TRAINER ==================== -->
        <div x-show="showTrainerModal" class="fixed inset-0 z-50 overflow-y-auto bg-black/80 backdrop-blur-sm flex items-center justify-center p-4" x-cloak>
            <div class="bg-slate-900 border border-slate-800 rounded-3xl max-w-2xl w-full p-6 sm:p-8 shadow-2xl space-y-6" @click.away="showTrainerModal = false">
                <div class="flex items-center justify-between border-b border-slate-800 pb-4">
                    <div>
                        <h3 class="text-lg font-black text-white tracking-tight">Add Fitness Trainer</h3>
                        <p class="text-xs text-slate-400 mt-0.5">Register a certified coach or personal trainer</p>
                    </div>
                    <button type="button" @click="showTrainerModal = false" class="p-2 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 transition-colors cursor-pointer">
                ...
                <form action="{{ route('app.trainers.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="full_name" required placeholder="e.g. Aditya Sharma" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:border-indigo-500 focus:outline-none">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-slate-300 mb-1">Phone Number *</label>
                            <input type="text" name="phone" required placeholder="e.g. 9876543210" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:border-indigo-500 focus:outline-none">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="email" name="email" placeholder="trainer@example.com" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:border-indigo-500 focus:outline-none">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-slate-300 mb-1">Specialization</label>
                            <input type="text" name="specialization" placeholder="e.g. Weight Training, CrossFit" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:border-indigo-500 focus:outline-none">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-slate-300 mb-1">Certification</label>
                            <input type="text" name="certification" placeholder="e.g. ACE, NASM, ISSA" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:border-indigo-500 focus:outline-none">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        <div>
                            ...
                            <input type="number" step="0.01" name="salary" placeholder="0.00" value="0.00" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:border-indigo-500 focus:outline-none">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-slate-300 mb-1">Salary Type</label>
                            <select name="salary_type" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:border-indigo-500 focus:outline-none">
                        ...
                        <div>
                            ...
                            <select name="salary_pay_day" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:border-indigo-500 focus:outline-none">
                        ...
                        <div>
                            ...
                            <input type="date" name="joining_date" value="{{ now()->toDateString() }}" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:border-indigo-500 focus:outline-none">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="status" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:border-indigo-500 focus:outline-none">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-slate-300 mb-1">Profile Photo</label>
                            <input type="file" name="photo" accept="image/*" class="w-full px-3 py-2 rounded-xl bg-slate-950 border border-slate-800 text-slate-300 text-xs file:mr-2 file:py-1 file:px-2.5 file:rounded-lg file:border-0 file:text-xs file:bg-indigo-600 file:text-white file:font-bold">
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end gap-3 pt-3 border-t border-slate-800">
                        <button type="button" @click="showTrainerModal = false" class="px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-bold transition-all cursor-pointer">Cancel</button>
                        <button type="submit" class="px-6 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-black text-xs shadow-lg shadow-indigo-600/20 transition-all cursor-pointer">Save Trainer</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div x-show="showTrainerEditModal" class="fixed inset-0 z-50 overflow-y-auto bg-black/85 backdrop-blur-sm flex items-center justify-center p-3 sm:p-6" x-cloak>
            <div class="bg-slate-900 border border-slate-800 rounded-3xl max-w-4xl w-full max-h-[92vh] overflow-y-auto p-6 sm:p-8 shadow-2xl space-y-6" @click.away="showTrainerEditModal = false">
                ...
                <div class="flex items-center justify-between border-b border-slate-800 pb-4">
                    <div>
                        <h3 class="text-lg font-black text-white tracking-tight">Edit Trainer &amp; Member Assignments</h3>
                        <p class="text-xs text-slate-400 mt-0.5">Update profile, compensation details, and manage assigned gym members</p>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <button type="button" @click="showTrainerEditModal = false" class="p-2 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 transition-colors cursor-pointer">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
                        </button>
                    </div>
                </div>
                ...
                <form :action="'{{ url('/app/trainers') }}/' + trainerForm.id" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="flex items-center gap-5 p-4 rounded-2xl bg-slate-950/60 border border-slate-800">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-slate-400 mt-1">JPG, PNG or GIF. Click photo or button to change.</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="phone" x-model="trainerForm.phone" required placeholder="e.g. 9090909090" class="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-white text-xs focus:border-indigo-500 focus:outline-none">
                            </div>
                        </div>
                    ...
                    <div class="pt-6 border-t border-slate-800 space-y-4">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-3 p-3 rounded-2xl bg-slate-950/70 border border-slate-800">
                            <div class="flex items-center gap-1.5 text-xs font-bold">
                                <button type="button" @click="trainerMemberFilter = 'all'" :class="trainerMemberFilter === 'all' ? 'bg-indigo-600 text-white shadow' : 'bg-slate-900 text-slate-400 hover:text-white'" class="px-3 py-1.5 rounded-xl border border-slate-800 transition-colors cursor-pointer">
                                    All Members (<span x-text="membersList.length"></span>)
                                </button>
                                <button type="button" @click="trainerMemberFilter = 'assigned'" :class="trainerMemberFilter === 'assigned' ? 'bg-indigo-600 text-white shadow' : 'bg-slate-900 text-slate-400 hover:text-white'" class="px-3 py-1.5 rounded-xl border border-slate-800 transition-colors cursor-pointer">
                                    Assigned (<span x-text="assignedCount"></span>)
                                </button>
                                <button type="button" @click="trainerMemberFilter = 'unassigned'" :class="trainerMemberFilter === 'unassigned' ? 'bg-indigo-600 text-white shadow' : 'bg-slate-900 text-slate-400 hover:text-white'" class="px-3 py-1.5 rounded-xl border border-slate-800 transition-colors cursor-pointer">
                    ...
                    <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-800">
                        <button type="button" @click="showTrainerEditModal = false" class="px-5 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-bold transition-all cursor-pointer">Cancel</button>
                        <button type="submit" class="px-6 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-extrabold text-xs shadow-lg shadow-indigo-500/20 flex items-center gap-2 transition-all cursor-pointer">
        ...
        <div x-show="showDeleteModal" class="fixed inset-0 z-50 overflow-y-auto bg-black/80 backdrop-blur-sm flex items-center justify-center p-4" x-cloak>
            <div class="bg-slate-900 border border-slate-800 rounded-3xl max-w-md w-full p-6 sm:p-7 shadow-2xl space-y-5 text-center" @click.away="showDeleteModal = false">
                ...
                <div class="space-y-2">
                    <h3 class="text-base font-black text-white tracking-tight">Delete Trainer Profile</h3>
                    <p class="text-xs text-slate-400 leading-relaxed">
                        Are you sure you want to remove <span class="font-bold text-white" x-text="trainerToDelete.name"></span>? Any assigned gym members will be unassigned from this coach.
                    </p>
                </div>

                <div class="flex items-center justify-center gap-3 pt-2">
                    <button type="button" @click="showDeleteModal = false" class="flex-1 py-2.5 px-4 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 font-bold text-xs transition-all cursor-pointer">
                        Cancel
                    </button>
                    ...
                    <form :action="'{{ url('/app/trainers') }}/' + trainerToDelete.id" method="POST" class="flex-1 inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="w-full py-2.5 px-4 rounded-xl bg-rose-600 hover:bg-rose-500 text-white font-black text-xs shadow-lg shadow-rose-600/25 hover:shadow-rose-600/35 transition-all cursor-pointer">
                            Yes, Delete
                        </button>
                    </form>
                </div>
